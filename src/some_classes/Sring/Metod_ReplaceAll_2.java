...
//Zameniaem s pomosch`y replaceAll(regex, String replacement) vse simvoli ot n do z na "" ,t.e. mozzno skazat ydaliaem ix iz stroki
//berem iznachalnyy dlinny stroki i ot nee otnimaem dlinny kotoraia polychilas v rezyltate vipolnenie(ydaleniia) replaceAll();
//polychaem kolichestvo ydalennix simvolov. A po ysloviy zadachi kolichestvo oshibok
public class Metod_ReplaceAll_2 {
